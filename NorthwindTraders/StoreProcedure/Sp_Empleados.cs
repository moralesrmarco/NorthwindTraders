...
GO
CREATE OR ALTER   PROCEDURE [dbo].[SP_EMPLEADOS_PAIS]
AS
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
CREATE OR ALTER   PROCEDURE [dbo].[SP_EMPLEADOS_LISTAR]
	@top100 Bit = 1
AS
BEGIN
	If @top100 = 1
...
SET QUOTED_IDENTIFIER ON
GO
CREATE OR ALTER PROCEDURE [dbo].[SP_EMPLEADOS_BUSCAR]
	@Id int, 
	@Nombres nvarchar(10),
...
BEGIN
		...
		Employees AS Employees_1 ON Employees.ReportsTo = Employees_1.EmployeeID
		WHERE
		(@Id = 0 OR Employees.EmployeeID = @Id) AND
...
SET QUOTED_IDENTIFIER ON
GO
ALTER   PROCEDURE [dbo].[SP_EMPLEADOS_NOMBRES]
AS
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
CREATE OR ALTER PROCEDURE [dbo].[SP_EMPLEADOS_INSERTAR]
	@Nombres nvarchar(10),
	@Apellidos nvarchar(20),
	@Titulo nvarchar(30),
...
SET QUOTED_IDENTIFIER ON
GO
CREATE OR ALTER PROCEDURE [dbo].[SP_EMPLEADOS_ACTUALIZAR]
	@Id int,
	@Nombres nvarchar(10),
	@Apellidos nvarchar(20),
	@Titulo nvarchar(30),
...
SET QUOTED_IDENTIFIER ON
GO
CREATE OR ALTER PROCEDURE [dbo].[SP_EMPLEADOS_ELIMINAR]
	@Id int
AS
BEGIN
		DELETE Employees 
