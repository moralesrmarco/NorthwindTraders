...
namespace NorthwindTraders
{
    public partial class FrmProductosCrudDap : Form
    {
        ...
        private void FrmProductosCrudDap_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void FrmProductosCrudDap_FormClosed(object sender, FormClosedEventArgs e)
        {
            Utils.ActualizarBarraDeEstado("Activo", this);
        }
